...
def brazil_bcb_sicor_microdados_operacoes_flow():
    ...
    DATASET_ID = Parameter("DATASET_ID", default="brazil_rural_credit")
    TABLE_ID = Parameter("TABLE_ID", default="microdados_operacao")
    DBT_MODEL_NAME = Parameter("DBT_MODEL_NAME", default="brazil_rural_credit__microdados_operacao.sql")
...
def brazil_bcb_sicor_complemento_operacao_flow():
    ...
    DATASET_ID = Parameter("DATASET_ID", default="brazil_rural_credit")
    TABLE_ID = Parameter("TABLE_ID", default="recurso_publico_complemento_operacao")
    DBT_MODEL_NAME = Parameter("DBT_MODEL_NAME", default="brazil_rural_credit__recurso_publico_complemento_operacao.sql")
